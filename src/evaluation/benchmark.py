...
def run_dataset_benchmark(
    ...
    if dataset.seasonal_period is None:
        raise ValueError(f"{BOLD}{RED}{dataset_name}{RESET} must define {BOLD}seasonal_period{RESET}.")
        ...
        for prediction_length in prediction_lengths:
            ...
            for window in windows:
                ...
                if not np.isfinite(forecast.predictions).all():
                    raise ValueError(f"{BOLD}{YELLOW}{forecast.model_name}{RESET} produced non-finite values.")
